...
if os.path.exists(results_files_path): # if it exist already
    ...
    shutil.rmtree(results_files_path)  # 删除指定路径

os.makedirs(results_files_path) # 新建指定路径
if draw_plot:
    ...
    for class_index, class_name in enumerate(gt_classes):
        ...
        for idx, detection in enumerate(dr_data):
            ...
            if show_animation:
                ...
                ground_truth_img = glob.glob1(IMG_PATH, file_id + ".*") # 读取文件夹下所有文件
        ...
        if draw_plot:
            ...
            # set window title
            fig = plt.gcf() # gcf - get current figure
            # fig.canvas.set_window_title('AP ' + class_name) # Matplotlib 3.4 已弃用 canvasset_window_title
